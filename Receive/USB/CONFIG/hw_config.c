...
void SendKeyboardData(u8 buf0,u8 buf1, u8 buf2,u8 buf3, u8 buf4,u8 buf5, u8 buf6,u8 buf7)
{
	u8 Buffer[8] = {0, 0, 0, 0, 0, 0, 0, 0};
	Buffer[0] = buf0;
	Buffer[1] = buf1;
...
void SendMouseData(u8 key, u8 x, u8 y, u8 scroll)
{
  u8 Buffer[8] = {1, 0, 0, 0, 0, 0, 0, 0};
